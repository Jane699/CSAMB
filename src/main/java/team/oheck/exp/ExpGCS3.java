...
public class ExpGCS3 {
    ...
    public void saveToFile(String[][] data1, String[][] data2) {
        ...
        String saveFilePathDetail = savePath + "gcs3/" + name + "/" + dataSet.substring(0, dataSet.lastIndexOf(".")) + "#" + DateTimeUtil.now() + ".csv";
        String saveFilePathFinalRes = savePath + "gcs3/" + name + "/final_res/" + dataSet.substring(0, dataSet.lastIndexOf(".")) + "#" + DateTimeUtil.now() + ".csv";

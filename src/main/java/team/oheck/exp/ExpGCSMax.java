...
public class ExpGCSMax {
    ...
    public void saveToFile(String[][] data1, String[][] data2) {
        ...
        String saveFilePathDetail = savePath + "gcs_max/" + name + "/" + dataSet.substring(0, dataSet.lastIndexOf(".")) + "#" + DateTimeUtil.now() + ".csv";
        String saveFilePathFinalRes = savePath + "gcs_max/" + name + "/final_res/" + dataSet.substring(0, dataSet.lastIndexOf(".")) + "#" + DateTimeUtil.now() + ".csv";
